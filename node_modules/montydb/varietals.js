...
module.exports = function(sequelize, DataTypes) {
  var Varietals = sequelize.define('Varietals', {
    ...
    bubble1: DataTypes.TEXT,
    bubble2:DataTypes.TEXT,
    bubble3: DataTypes.TEXT,
    bubble4:DataTypes.TEXT,
    type:{
      type: DataTypes.ENUM,
    ...
    classMethods: {
      associate: function(models) {
        ...
        Varietals.belongsToMany(models.Locations, {
          through: 'VarietalsLocations'
        });
