...
if (!global.hasOwnProperty('db')) {
  ...
  sequelize = new Sequelize(config.get('DBCONNECTION'), {
    native: true,
    logging: true
  });
  //blah blah
  ...
  global.db = {
    ...
    TastingNotes: sequelize.import(__dirname + '/tasting-notes'),
    ...
    IntentsAttributes: sequelize.import(__dirname + '/intents-attributes'),
    Intents: sequelize.import(__dirname + '/intents'),
    IntentVarietals: sequelize.import(__dirname + '/intent-varietals'),
    Locations: sequelize.import(__dirname + '/locations'),
    WinesVarietals: sequelize.import(__dirname + '/wines-varietals'),
    Channel: sequelize.import(__dirname + '/channel'),
    TrackingEvents: sequelize.import(__dirname + '/tracking-events')
  }
